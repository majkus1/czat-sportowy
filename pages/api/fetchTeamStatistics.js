...
export default async function handler(req, res) {
  ...
  if (!teamId || !leagueId) {
    return res.status(400).json({ error: 'Missing teamId or leagueId in request body' });
  }
  ...
  try {
    ...
    res.status(200).json({ playedTotal, form, goalsOver05, goalsUnder05, goalsOver15, goalsUnder15, goalsOver25, goalsUnder25, goalsOver35, goalsUnder35, goalsOver05aga, goalsUnder05aga, goalsOver15aga, goalsUnder15aga, goalsOver25aga, goalsUnder25aga, goalsOver35aga, goalsUnder35aga, goalsfortotal, goalsforhome, goalsforaway, goalsagatotal, goalsagahome, goalsagaaway, winstotal, winshome, winsaway, drawstotal, drawshome, drawsaway, losestotal, loseshome, losesaway, cleansheettotal, cleansheethome, cleansheetaway, failedtoscoretotal, failedtoscorehome, failedtoscoreaway
     });
  } catch (error) {
